...
public class ListHistoryCashCollection extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_history_cash);
        ...
        historyview = (ListView) findViewById(R.id.listViewcash);
        //typeofCommand = s.split("\\$");
        if(bundle.getString("data")!= null) {
            String s;
            s = typeofCommandHistory[1];
            s = s.replace("#", ":");
            String[] historylist;
            s = s.replace("^", "    ");
            s=s.replaceAll("\\[.*?\\]", "");
